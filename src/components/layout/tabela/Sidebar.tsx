...
export default function Sidebar() {
  return (
    <div  className="bg-militar-300">
      <div className="bg-chocolate font-dm-sans w-20 sm:w-48 h-screen flex flex-col rounded-r-3xl justify-between transition-all duration-300 z-50">
        {/* topo */}
