  ...
  return (
    <main className="bg-offwhite min-h-screen py-12 px-4 sm:px-6 lg:px-8 font-dm-sans text-chocolate animate-fade-in">
      ...
      <div className="font-dm-sans text-chocolate/80 max-w-3xl mx-auto mt-10 space-y-8 leading-relaxed">
        <p>
          <span className="text-2xl md:text-3xl font-source-serif font-bold text-chocolate">
            Bem-vindo ao Midori Café!
            <br />
          </span>{" "}
          O Midori Café nasceu para ser mais do que um lugar para tomar café. É
          um espaço para desacelerar, encontrar pessoas, trabalhar em silêncio,
          conversar por horas ou simplesmente ter alguns minutos para você.
          Estes Termos de Uso explicam as regras para utilização da nossa
          aplicação e dos serviços oferecidos pelo Midori Café. Ao acessar ou
          utilizar a plataforma, você declara que leu e concorda com estes
          termos.
        </p>
        <br />
        <h2 className="text-2xl md:text-2xl font-source-serif font-bold text-chocolate">
          1. Sobre o Midori Café
        </h2>
        <p>
        ...
        <p>
          ...
          contato pelos canais oficiais do Midori Café disponíveis{" "}
          <Link href="/contato">
