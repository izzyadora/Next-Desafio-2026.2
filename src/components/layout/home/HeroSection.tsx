...
export default function Hero() {
  return (
    <section className="bg-offwhite text-creme w-full flex flex-col items-center justify-center min-h-[80vh] gap-16 px-4 py-24 sm:px-16 border-b border-chocolate/20 animate-fade-in">
